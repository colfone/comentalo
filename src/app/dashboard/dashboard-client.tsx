        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          <div className="space-y-4 lg:col-span-3">
            ...
            {[
              ...
              { icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>, color: "#6200EE", label: "Campañas activas", value: stats.campanasActivas },
            ].map((s) => (
