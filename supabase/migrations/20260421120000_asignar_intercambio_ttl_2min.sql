-- ============================================
-- RPC asignar_intercambio — TTL reservas 5 min → 2 min
-- Única diferencia vs 20260420010000_asignar_intercambio_language_sql.sql:
-- la línea del INSERT pasa de `interval '5 minutes'` a `interval '2 minutes'`.
-- Acompaña el timer de reasignación silenciosa del frontend (115s).
