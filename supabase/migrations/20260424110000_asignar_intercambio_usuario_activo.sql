-- ============================================
-- RPC asignar_intercambio — filtro por estado del usuario
-- Diferencia vs 20260421120000_asignar_intercambio_ttl_2min.sql:
-- (1) CTE locked_disponibles: agregado EXISTS que exige usuarios.estado='activo'
--     para el comentarista. Suspendidos/baneados/eliminados no pueden tomar
--     videos de la cola aunque lleguen al RPC via API directa (el gate del
--     layout los bloquea antes, pero este guard es defensivo).
-- (2) CASE final: nuevo branch USUARIO_NO_ACTIVO al inicio, antes que
--     USUARIO_SIN_VIDEO_ACTIVO, para que el mensaje refleje el motivo real.
-- ============================================
